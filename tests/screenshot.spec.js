...
test('has title', async ({ page },testInfo) => {
  ...
  // test-results/timestamp/has title/screenshot2.png
  const savePath = path.join('test-results', testInfo.title, timestamp, 'screenshot2.png');
